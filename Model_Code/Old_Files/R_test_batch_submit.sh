#!/bin/bash
#SBATCH -J WOLCAN_scen19_        # Job name for the array
#SBATCH -o WOLCAN_scen19_%A.out  # Shared standard output with job ID
#SBATCH -e WOLCAN_scen19_%A.err  # Shared standard error with job ID
#SBATCH -p shared      # Partition to submit to
#SBATCH -c 8	       # Number of cores (for parallelization)
#SBATCH -N 1           # Number of nodes
#SBATCH -t 0-2:00:00  # Runtime (D-HH:MM:SS)
#SBATCH --mem=6000     # Memory request
