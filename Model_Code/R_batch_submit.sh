#!/bin/bash
#SBATCH -J WOLCAN_scen11_        # Job name for the array
#SBATCH -o WOLCAN_scen11_%A.out  # Shared standard output with job ID
#SBATCH -e WOLCAN_scen11_%A.err  # Shared standard error with job ID
