#!/bin/bash
#SBATCH -J WOLCAN_scen7_        # Job name for the array
#SBATCH -o WOLCAN_scen7_%A.out  # Shared standard output with job ID
#SBATCH -e WOLCAN_scen7_%A.err  # Shared standard error with job ID
