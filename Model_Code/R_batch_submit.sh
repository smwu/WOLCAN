#!/bin/bash
#SBATCH -J WOLCAN_scen18_        # Job name for the array
#SBATCH -o WOLCAN_scen18_%A.out  # Shared standard output with job ID
#SBATCH -e WOLCAN_scen18_%A.err  # Shared standard error with job ID
