#!/bin/bash
#SBATCH -J WOLCAN_scen23_        # Job name for the array
#SBATCH -o WOLCAN_scen23_%A.out  # Shared standard output with job ID
#SBATCH -e WOLCAN_scen23_%A.err  # Shared standard error with job ID
