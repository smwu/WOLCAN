#!/bin/bash
#SBATCH -J WOLCAN_scen10_        # Job name for the array
#SBATCH -o WOLCAN_scen10_%A.out  # Shared standard output with job ID
#SBATCH -e WOLCAN_scen10_%A.err  # Shared standard error with job ID
