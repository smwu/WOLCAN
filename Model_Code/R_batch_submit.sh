#!/bin/bash
#SBATCH -J WOLCAN_scen25_        # Job name for the array
#SBATCH -o WOLCAN_scen25_%A.out  # Shared standard output with job ID
#SBATCH -e WOLCAN_scen25_%A.err  # Shared standard error with job ID
...
scenario=25
Rscript /n/netscratch/stephenson_lab/Lab/stephwu18/WOLCAN/Model_Code/model_sims.R ${scenario} ${SLURM_ARRAY_TASK_ID}
