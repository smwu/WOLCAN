#!/bin/bash
#SBATCH -J WOLCAN_scen8_        # Job name for the array
#SBATCH -o WOLCAN_scen8_%A.out  # Shared standard output with job ID
#SBATCH -e WOLCAN_scen8_%A.err  # Shared standard error with job ID
